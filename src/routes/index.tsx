...
function Logo() {
  return (
    <div className="flex items-center gap-2">
      <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-primary to-[oklch(0.68_0.20_285)] text-primary-foreground shadow-lg shadow-primary/30">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 pt-16 pb-24 lg:grid-cols-2 lg:pt-24">
          ...
          <div className="animate-fade-up">
            <span className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-3 py-1.5 text-xs font-semibold text-primary">
              <MessageCircle className="h-3.5 w-3.5" /> FACTURACIÓN DESDE WHATSAPP
            </span>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-4">
              ...
              <a
                href="#demo-video"
                className="inline-flex items-center gap-2 rounded-xl border border-border bg-card px-6 py-3.5 text-sm font-semibold text-foreground transition-all hover:border-primary/40 hover:bg-primary/5"
              >
            ...
            <p className="mt-4 flex items-center gap-2 text-xs text-muted-foreground">
              ...
              Probá todas las funciones. Sin tarjeta de crédito.
            </p>
          </div>
        ...
        <div className="border-y border-border bg-card/40">
          <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-6 px-6 py-6">
            <p className="text-sm font-medium text-muted-foreground">
              Más de <span className="font-bold text-foreground">6.000 empresas</span> ya confían en Factyble
            </p>
            <div className="flex flex-wrap items-center gap-x-8 gap-y-3 text-sm font-semibold text-muted-foreground">
              {["Acme", "Globex", "Sigma", "Umbrella", "Initech"].map((n) => (
                <span key={n} className="flex items-center gap-2 opacity-80 transition-opacity hover:opacity-100">
                  <span className="inline-block h-5 w-5 rounded-md bg-gradient-to-br from-primary/70 to-[oklch(0.68_0.20_285)]" />
                  {n}
                </span>
              ))}
            </div>
